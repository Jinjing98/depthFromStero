...
img1 = cv.imread('data/1/left/00001.png',cv.IMREAD_GRAYSCALE)          # queryImage
img2 = cv.imread('data/1/right/00001.png',cv.IMREAD_GRAYSCALE)         # trainImage
...
# print('\nthe num of unfiltered matched kp pairs :' + str(len(matches)))
